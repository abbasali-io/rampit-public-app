...
import 'package:rampit/ui/widgets/dumb_widgets/reciept_info/reciept_info_widget.dart';
...
class OrderDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<OrderDetailsViewModel>.reactive(
      ...
      onModelReady: (OrderDetailsViewModel model) async {
        await model.init();
      },
      builder: (
          ...
          body: Container(
            ...
            child: ListView(
              ...
              children: [
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return selectedItemInfo(
                          size: size,
                          itemImagePath: model.productData![index]['image']!,
                          itemName: model.productData![index]['productTitle']!,
                          itemQuantity: model.productData![index]['quantity']!,
                          itemPrice: model.productData![index]['productPrice']!,
                        );
                      }),
                ),
                SizedBox(
                ...
                shippingAddressInfo(size: size, model: model),
                SizedBox(
  ...
  Widget shippingAddressInfo({required Size size, required OrderDetailsViewModel model}) {
    return Container(
      ...
      child: Column(
          ...
          children: [
            driverInfoTile(
      size: size,
      driverImage: model.driverImageUrl!,
